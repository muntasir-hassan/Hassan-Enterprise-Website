  ...
  return (
    ...
    >
      ...
      <div className="md:grid grid-cols-3 max-w-4xl">
        <div className="flex flex-col ml-4 items-center min-w-56 max-md:w-3/5 rounded-xl bg-green-950 py-8 mb-8 hover:shadow-green-950 shadow-2xl cursor-pointer transition-all duration-300 max-w-64 scale-90 hover:scale-100 ">
          <div className="h-32 w-32">
            <img src={img2} className="h-full rounded-full object-cover" />
          </div>
          <div className="px-3 py-2 text-white">
            <h3 className="font-medium text-xl text-center mb-1">Abidur Rahman</h3>
            <p>
        ...
        <div className="flex flex-col ml-4 items-center min-w-56 max-md:w-3/5 rounded-xl bg-green-950 py-8 mb-8 hover:shadow-green-950 shadow-2xl cursor-pointer transition-all duration-300 max-w-64 max-md:scale-90 hover:scale-100 md:hover:scale-105 -translate-y-3">
          <div className="h-32 w-32">
            <img src={img1} className="h-full rounded-full object-cover" />
          </div>
          <div className="px-3 py-2 text-white">
            <h3 className="font-medium text-xl text-center mb-1">Mustak Miya</h3>
            <p>
        ...
        <div className="flex flex-col ml-4 items-center min-w-56 max-md:w-3/5 rounded-xl bg-green-950 py-8 mb-8 hover:shadow-green-950 shadow-2xl cursor-pointer transition-all duration-300 max-w-64 scale-90 hover:scale-100">
          ...
          <div className="px-3 py-2 text-white">
            <h3 className="font-medium text-xl text-center mb-1">Fokrul Ahmed</h3>
            <p>
